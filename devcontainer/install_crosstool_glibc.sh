...
echo "VSCODE_SERVER_CUSTOM_GLIBC_LINKER=$HOME/alt_toolchain/x86_64-linux-gnu/x86_64-linux-gnu/sysroot/lib/ld-linux-x86-64.so.2" >> $HOME/.bashrc
echo "VSCODE_SERVER_CUSTOM_GLIBC_PATH=$HOME/alt_toolchain/x86_64-linux-gnu/x86_64-linux-gnu/sysroot/lib/" >> $HOME/.bashrc
echo "VSCODE_SERVER_PATCHELF_PATH=$HOME/git/bin/patchelf" >> $HOME/.bashrc
